        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index_stud.php" class="site_title"><i class="fa fa-book"></i> <span>Classes Dashboard!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="http://localhost/VIRTUAL%20CLASSROOM%20PROJECT/dashboard/dashboard_stud.php"><i class="fa fa-dashboard"></i>Dasboard <span ></span></a>
