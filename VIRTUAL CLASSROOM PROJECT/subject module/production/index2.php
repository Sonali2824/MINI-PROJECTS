...
<html lang="en">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index2.php" class="site_title"><i class="fa fa-book"></i> <span>Classes Dashboard!</span></a>
            </div>
 ...
 $tb=$_SESSION["username"]."_".$_SESSION["sub"]."_ass";
...
print "<tr><td>$row[0]</td><td><a href=$row[1] target='_blank'>Click to View Content</a></td><td><a href=$row[3] target='_blank'>Click to Submit</a></td>";
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="add_ass.php" method="post">

                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name"> Name of the Assignment <span class="required">*</span>
                      </label>
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="link">Link for the Assignment Content <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="sub_link">Link for  Submission <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form21" data-parsley-validate class="form-horizontal form-label-left" action="upd_ass.php" method="post">


                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name1">Name of the Assignment <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="link1">Updated Link for Assignment Content <span ></span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="sub_link1">Updated Link for Submission  <span ></span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form22" data-parsley-validate class="form-horizontal form-label-left" action="del_ass.php" method="post">


                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name2">Name of the Assignment <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
