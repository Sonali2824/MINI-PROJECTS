...
<html lang="en">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index4.php" class="site_title"><i class="fa fa-book"></i> <span>Classes Dashboard!</span></a>
            </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>Name</th>
                          <th>Link for the Question Paper</th>
                          <th>Link for Submission of Answer Scripts</th>
 ...
 $tb=$_SESSION["username"]."_".$_SESSION["sub"]."_exam";
...
print "<tr><td>$row[0]</td><td><a href=$row[1] target='_blank'>Click to View Question Paper</a></td><td><a href=$row[3] target='_blank'>Click to Submit</a></td>";
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="add_exam.php" method="post">

                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name"> Name of the Examination <span class="required">*</span>
                      </label>
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="link">Link for the Question Paper <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="sub_link">Link for  Submission of Answer Script <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="upd_exam.php" method="post">


                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name1">Name of the Examination <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="link1">Updated Link for Question Paper <span ></span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="sub_link1">Updated Link for Submission of Answer Script  <span ></span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="del_exam.php" method="post">


                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name2">Name of the Exam <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
