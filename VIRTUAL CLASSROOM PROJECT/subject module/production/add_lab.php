...
<?php
 ...
 $tb=strtolower($_SESSION["username"])."_".$_SESSION["sub"]."_ass";
...
function newAss(){
 ...
 $tb=strtolower($_SESSION["username"])."_".$_SESSION["sub"]."_lab";
 
$query="insert into ".$tb. " values('$name','$link', '$info', '$slink');";

$res= (mysqli_query($conn, $query));

header('Refresh:1; url="http://localhost/VIRTUAL%20CLASSROOM%20PROJECT/subject%20module/production/index5.php"'); 
