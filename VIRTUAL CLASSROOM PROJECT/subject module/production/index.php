...
<html lang="en">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-book"></i> <span>Classes </span></a>
            </div>
 ...
 $tb=$_SESSION["username"]."_".$_SESSION["sub"]."_ann";
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="add_ann.php" method="post">

                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name"> Title  of the Announcement <span class="required">*</span>
                      </label>
                    ...
                    <div class="item form-group">
                      <label for="info" class="col-form-label col-md-3 col-sm-3 label-align">Content of the Announcement<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 ">
                        <textarea id="info" class="form-control" type="text" required="required" name="info"></textarea>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form21" data-parsley-validate class="form-horizontal form-label-left" action="upd_ann.php" method="post">

                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name1"> Title  of the Announcement <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                      <label for="info1" class="col-form-label col-md-3 col-sm-3 label-align"> Updated Content of the Announcement<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 ">
                        <textarea id="info1" class="form-control" type="text" required="required" name="info1"></textarea>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form22" data-parsley-validate class="form-horizontal form-label-left" action="del_ann.php" method="post">


                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="name2">Title of the Announcement <small>(as previously entered)</small> <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
